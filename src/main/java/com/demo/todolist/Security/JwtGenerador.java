...
public class JwtGenerador {
    ...
    public String generarToken(Authentication authentication) {
        ...
        String token = Jwts.builder() //Construimos un token JWT llamado token
                ...
                .signWith(SignatureAlgorithm.HS512, "firma") /*Utilizamos este método para firmar
    ...
    public String obtenerUsernameDeJwt(String token) {
        Claims claims = Jwts.parser() // El método parser se utiliza con el fin de analizar el token
                .setSigningKey("firma")// Establece la clave de firma, que se utiliza para verificar la firma del token
